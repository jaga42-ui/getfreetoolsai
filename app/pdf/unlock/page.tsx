...
export const metadata = toolMeta({
  ...
  description:
    "Remove password protection from PDF files free. Enter your password and download an unlocked PDF instantly. 100% private — password never sent to any server.",
  keywords:
