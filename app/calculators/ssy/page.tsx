...
export const metadata = toolMeta({
  ...
  description:
    "Calculate the maturity value of a Sukanya Samriddhi Yojana (SSY) account. Free SSY calculator with 15 years of deposits, 21-year maturity and total interest.",
  keywords:
