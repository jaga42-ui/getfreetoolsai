...
export const metadata = toolMeta({
  ...
  description:
    "Calculate National Savings Certificate (NSC) maturity value and interest. Free NSC calculator for the 5-year scheme with annually compounded interest. No signup.",
  keywords:
