...
export const funTools: Tool[] = [
  ...
  { name: "Error Message Generator", description: "Windows error popups as PNG", href: "/fun/fake-error", icon: TriangleAlert, ready: true },
  { name: "Fake Blue Screen", description: "Full-screen BSOD prank generator", href: "/fun/blue-screen", icon: MonitorX, ready: true },
